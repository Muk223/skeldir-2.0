...
- **Candidate SHA:** `a3148a367110e4d02f400152baafc852357598a4`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34521120406
- **Generated at:** `2026-09-10T19:44:57.616851+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-10T19:35:16.351767+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.107,
  "latency_p95_ms": 6.935,
...
```json
{
  ...
  "latency_p50_ms": 28.384,
  "latency_p95_ms": 33.593,
  "latency_p99_ms": 39.816,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-10T19:38:57.446772+00:00",
  "window_start_utc": "2026-09-10T19:37:57.422100+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 33.727,
  "latency_p95_ms": 46.236,
  "latency_p99_ms": 70.128,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-10T19:39:57.543692+00:00",
  "window_start_utc": "2026-09-10T19:38:57.486987+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 33.812,
  "latency_p50_ms": 29.886,
  "latency_p95_ms": 32.871,
  "latency_p99_ms": 36.669,
  "latency_second_half_p95_ms": 32.092,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-10T19:44:57.440896+00:00",
  "window_start_utc": "2026-09-10T19:39:57.588437+00:00"
}
```
