...
- **Candidate SHA:** `12db04030155edeef835bf4f77eeb6174efdc784`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34083332112
- **Generated at:** `2026-09-07T05:03:22.112384+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-07T04:53:49.415987+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.137,
  "latency_p95_ms": 16.673,
...
```json
{
  ...
  "latency_p95_ms": 32.756,
  "latency_p99_ms": 38.673,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-07T04:57:21.933117+00:00",
  "window_start_utc": "2026-09-07T04:56:21.907422+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 36.137,
  "latency_p95_ms": 53.807,
  "latency_p99_ms": 66.004,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-07T04:58:22.042090+00:00",
  "window_start_utc": "2026-09-07T04:57:21.974398+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 34.134,
  "latency_p50_ms": 29.681,
  "latency_p95_ms": 33.137,
  "latency_p99_ms": 37.123,
  "latency_second_half_p95_ms": 32.028,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-07T05:03:21.944057+00:00",
  "window_start_utc": "2026-09-07T04:58:22.088563+00:00"
}
```
