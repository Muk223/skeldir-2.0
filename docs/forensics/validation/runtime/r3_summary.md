...
- **Candidate SHA:** `bad9f6405f992bad7c8d87cfb0c7b650547c6c97`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34549893066
- **Generated at:** `2026-09-11T01:25:17.965830+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-11T01:15:40.692084+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.326,
  "latency_p95_ms": 14.372,
...
```json
{
  ...
  "latency_p50_ms": 28.297,
  "latency_p95_ms": 32.254,
  "latency_p99_ms": 36.568,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-11T01:19:17.800470+00:00",
  "window_start_utc": "2026-09-11T01:18:17.777840+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 32.593,
  "latency_p95_ms": 38.178,
  "latency_p99_ms": 51.563,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-11T01:20:17.892544+00:00",
  "window_start_utc": "2026-09-11T01:19:17.839233+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 34.07,
  "latency_p50_ms": 30.403,
  "latency_p95_ms": 33.498,
  "latency_p99_ms": 36.533,
  "latency_second_half_p95_ms": 33.259,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-11T01:25:17.790222+00:00",
  "window_start_utc": "2026-09-11T01:20:17.938812+00:00"
}
```
