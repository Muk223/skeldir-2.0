...
- **Candidate SHA:** `67a9d245609cc814bbcf4b156ea434ef351f43b6`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34416002463
- **Generated at:** `2026-09-09T23:24:34.686312+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-09T23:15:03.402158+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.094,
  "latency_p95_ms": 3.779,
...
```json
{
  ...
  "latency_p50_ms": 25.985,
  "latency_p95_ms": 27.976,
  "latency_p99_ms": 32.651,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-09T23:18:34.539547+00:00",
  "window_start_utc": "2026-09-09T23:17:34.518935+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 28.691,
  "latency_p95_ms": 32.158,
  "latency_p99_ms": 38.354,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-09T23:19:34.628725+00:00",
  "window_start_utc": "2026-09-09T23:18:34.577415+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 29.837,
  "latency_p50_ms": 26.559,
  "latency_p95_ms": 29.103,
  "latency_p99_ms": 32.467,
  "latency_second_half_p95_ms": 28.279,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-09T23:24:34.522121+00:00",
  "window_start_utc": "2026-09-09T23:19:34.671743+00:00"
}
```
