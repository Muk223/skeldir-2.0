...
- **Candidate SHA:** `4ffd6be4a4e1703df19c7770033c4bdf3a3cea76`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/21786103236
- **Generated at:** `2026-02-07T20:10:07.353751+00:00`
...
- `tenant_a` = `f2028fd8-f77c-523c-a84e-f2fa7a9d1e95`
- `tenant_b` = `1562167d-8df8-5b9e-902f-77189ef529e9`
...
{
  "N": 10,
  "candidate_sha": "4ffd6be4a4e1703df19c7770033c4bdf3a3cea76",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/21786103236",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "86df2ace-7fdf-5769-8784-5a6be2f5f409",
    ...
    "worker_pid_after": 3277,
    "worker_pid_before": 2774,
    "worker_pid_restarts": [
      2824,
      2933,
      2981,
...
```json
{
  ...
  "candidate_sha": "4ffd6be4a4e1703df19c7770033c4bdf3a3cea76",
  "db_truth": {
    "target_row_id": "97f90ea8-8948-4cd4-b979-3d104b622545"
  },
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/21786103236",
