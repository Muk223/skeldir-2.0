...
- EG-P0-3 (provider boundary scanner non-vacuous):
  - CI run: `https://github.com/Muk223/skeldir-2.0/actions/runs/21723348773/job/62658867123`
...
- EG-P0-4 (compose substrate bring-up + worker proof):
  - CI run: `https://github.com/Muk223/skeldir-2.0/actions/runs/21723348773/job/62658867090`
