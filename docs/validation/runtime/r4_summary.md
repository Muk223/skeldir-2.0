...
- **Candidate SHA:** `f759de17e63506198209a6e4e334496608543799`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/20580257822
- **Generated at:** `2025-12-29T18:50:13.298852+00:00`
...
- `tenant_a` = `2e4cc014-8ad9-5864-a048-9da34b51db73`
- `tenant_b` = `1dee2dd5-f1e6-50c1-a25a-5d7c9ef49a48`
...
{
  "N": 10,
  "candidate_sha": "f759de17e63506198209a6e4e334496608543799",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/20580257822",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "bb5e3952-8014-5f55-bb08-8b48c59f68cd",
    ...
    "worker_pid_after": 3171,
    "worker_pid_before": 2760,
    "worker_pid_restarts": [
      2804,
      2844,
      2887,
...
```json
{
  ...
  "candidate_sha": "f759de17e63506198209a6e4e334496608543799",
  "db_truth": {
    "target_row_id": "2eebb5a1-e3e9-419c-b141-4571f80d67a3"
  },
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/20580257822",
