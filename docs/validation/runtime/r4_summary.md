...
- **Candidate SHA:** `650839c4a43f78cd9b68ee13422e415b8f622e6c`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/20559486680
- **Generated at:** `2025-12-28T21:11:27.126934+00:00`
...
- `tenant_a` = `cda1a8e4-714d-50fe-8483-987e6907c4a3`
- `tenant_b` = `3a1741c7-430a-5554-9bd8-ed5053c668b8`
...
{
  "N": 10,
  "candidate_sha": "650839c4a43f78cd9b68ee13422e415b8f622e6c",
  "db_truth": {
    "attempts": {
      ...
      "attempts_max_per_task": 18,
      "attempts_min_per_task": 16,
      "attempts_total": 156,
      "task_count_observed": 9
    },
    "worker_failed_jobs": {
      "max_retry_count": 0,
      "rows": 2
  ...
  "passed": false,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/20559486680",
...
```json
{
  ...
  "worker_observed": {
    ...
    "redelivery_observed_count": 0,
    "worker_exit_codes": [],
    "worker_pid_after": 3666,
    "worker_pid_before": 3666,
    "worker_pid_restarts": []
  }
}
```
...
```json
{
  ...
  "tenant_b": "3a1741c7-430a-5554-9bd8-ed5053c668b8",
  "worker_observed": {
    "runaway_outcome": "OperationalError",
