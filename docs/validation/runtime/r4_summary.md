...
- **Candidate SHA:** `bf58cf8ed0606fd7ae0bb0a5eccd36ef043e6c99`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/20560416393
- **Generated at:** `2025-12-28T22:30:41.663627+00:00`
...
- `tenant_a` = `6a9c43af-2a11-529a-abc0-2c0ca441d5da`
- `tenant_b` = `cda22041-8931-5fd8-9c5d-97bfa91f7051`
...
{
  "N": 10,
  "candidate_sha": "bf58cf8ed0606fd7ae0bb0a5eccd36ef043e6c99",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/20560416393",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "38cdf4b8-ccfd-5c8a-b326-ff6fd531d031",
    ...
    "worker_pid_after": 2782,
    "worker_pid_before": 2693,
    "worker_pid_restarts": [
      2741,
      2782
    ]
