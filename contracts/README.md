...
- **Redoc**: `redocly preview-docs contracts/openapi/v1/auth.yaml`
- **Swagger UI**: `swagger-ui-serve contracts/openapi/v1/auth.yaml`
...
This generates models in `backend/app/schemas/` directory.
...
```bash
openapi-generator-cli validate -i contracts/openapi/v1/*.yaml
```
